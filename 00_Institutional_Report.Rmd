...
- age > 3 categories (41+ category) -> Timon
- discipline -> 4 categories, prefer not to say as NA, remove "Discipline of" and "incl." -> Timon
- position type: PhD, (Postdoc, above psotdoc), other (res with PhD, supportive, lecturing) -> Timon
- funding: SNF, non-SNF (inc. other), Uni -> Timon
- residence status: swiss + permit C vs. other permit -> Timon
