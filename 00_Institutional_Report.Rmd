...
rm(list = ls())
# Load data
load("../data/SWiMS2024_Data_2025-03-12.RData")
source("99_helpers.R")
...
```{r}
swims.plot.multibar(var = "discrimination", fill_colors = c("lightgreen","orange","darkorange","red3"))
swims.plot.multibar(var = "discrimination_type", fill_colors = c("lightgreen","red3"))
...
swims.plot.aggregation <- function(vars, 
                                institution = target_institution, 
                                data = dat, 
                                codeb = codebook, 
                                fill_colors = NULL,
...
# TODO: 
#left bar is institution, dann other ->TE
# proportion is percentage -> TE
# response order like in coebook -> TE
# alpha for other _> ZK


swims.plot.aggregation(var = "discrimination_type", institution = target_institution)
